...
Test Setup: Initialise all Objects, Connections with other components like
Databases etc. and remove any files that may affect your test cases

Test Teardown: Delete all Objects used in test cases, close connections and
remove any files created by the test cases
